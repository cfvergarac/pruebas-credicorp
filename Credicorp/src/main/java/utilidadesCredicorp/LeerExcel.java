...
public class LeerExcel {
	...
	LeerExcel.workbook = new XSSFWorkbook(file);
	LeerExcel.sheet = workbook.getSheetAt(0);
    setURL(this.sheet);
...
public static Object[][] obtenerExcel() throws Exception {
	...
	public static String obtenerDato(int fila, int col) throws Exception {
			  ...
			  Cell resultCell=(Cell) sheet.getRow(fila).getCell(col);
			  //Cell = sheet.getRow(fila).getCell(col);
			  String dato = String.valueOf(resultCell);  
			  return dato;
	}
